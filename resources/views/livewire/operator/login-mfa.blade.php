...
<div>
    <h1 class="text-xl font-semibold tracking-tight">Operator verification</h1>

    @if (! $useRecovery)
        <p class="mt-1 text-sm" style="color:var(--muted)">Enter the 6-digit code from your authenticator app.</p>
    ...
    @else
        <p class="mt-1 text-sm" style="color:var(--muted)">Enter one of the recovery codes you saved when enabling two-factor.</p>
