...
<div>
    ...
    <div class="mt-6">
        <input wire:model.live.debounce.300ms="search" type="search" class="input" style="max-width:24rem" placeholder="Search by entity ID" aria-label="Search SSO providers">
        {{-- SC 4.1.3: the list re-renders on a debounced keystroke with no focus
             ...
             narrowed to nothing. --}}
        <p role="status" aria-live="polite" class="sr-only">{{ $providers->total() }} {{ \Illuminate\Support\Str::plural('provider', $providers->total()) }} found.</p>
    </div>
