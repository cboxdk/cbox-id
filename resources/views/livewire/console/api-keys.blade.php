...
new #[Layout('components.layouts.app', ['title' => 'API keys'])] class extends Component
{
     ...
     * browser went on posting to /livewire/update and going on receiving the organization's API keys for as
    ...
    public function boot(ConsoleScope $scope): void
    {
        ...
        abort_unless($scope->capabilities()?->canManageMembers() === true, 403);
    }
