...
new #[Layout('components.layouts.app', ['title' => 'Environment keys'])] class extends Component
{
     ...
     * browser went on posting to /livewire/update and going on receiving the environment API keys and their scopes for as
    ...
    public function boot(ConsoleScope $scope): void
    {
        ...
        abort_unless($scope->capabilities()?->canManageEnvironments() === true, 403);
    }
