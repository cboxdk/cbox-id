<x-mail.layout>
    <h1 style="margin:0 0 12px;font-size:20px;color:#14161c">Reset your workspace password</h1>
    <p style="margin:0 0 20px;color:#5b616e;font-size:15px;line-height:1.6">
        We received a request to reset the password for your Cbox ID workspace — the console for
        your environments, members, and billing. Click below to choose a new one. This link is
        single-use and expires in 60 minutes. If you didn't request it, you can ignore this email.
    </p>
