...
@if ($sandbox)
    <div role="status" aria-live="polite"
         ...
         style="background:color-mix(in oklch, var(--warning) 16%, var(--background)); color:var(--warning); border-bottom:1px solid color-mix(in oklch, var(--warning) 30%, transparent)">
