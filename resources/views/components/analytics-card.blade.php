...
<div class="rounded-xl border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
    <div class="flex items-center gap-3">
        ...
        <div>
            <p class="text-sm font-medium text-neutral-500 dark:text-neutral-400">Logins (24h)</p>
            <p class="text-lg font-semibold tabular-nums text-neutral-900 dark:text-neutral-100">
                {{ number_format($logins) }}
            </p>
        </div>
    </div>
    <a href="{{ route('analytics.overview') }}" class="mt-4 inline-block text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">
        View analytics &rarr;
    </a>
</div>
