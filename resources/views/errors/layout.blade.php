        ...
        <div style="max-width:30rem;width:100%;text-align:center">
            ...
            @if ($traceId)
                <div style="margin-top:2.25rem;padding-top:1.5rem;border-top:1px solid var(--border)">
                    ...
                    <span data-copy-feedback aria-live="polite" style="display:block;font-size:.72rem;color:var(--accent-strong);margin-top:.4rem;min-height:1em;visibility:hidden">Copied</span>
                </div>
            @endif
        </div>
    </main>
