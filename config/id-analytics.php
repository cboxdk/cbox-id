...
return [
     ...
     */
    'enabled' => (bool) env('CBOX_ID_ANALYTICS_ENABLED', false),
     ...
     */
    'store' => (string) env('CBOX_ID_ANALYTICS_STORE', 'none'),
     ...
     */
    'clickhouse' => [
        'dsn' => (string) env('CBOX_ID_ANALYTICS_CLICKHOUSE_DSN', ''),
        'database' => (string) env('CBOX_ID_ANALYTICS_CLICKHOUSE_DATABASE', 'default'),
        'user' => (string) env('CBOX_ID_ANALYTICS_CLICKHOUSE_USER', 'default'),
        'password' => (string) env('CBOX_ID_ANALYTICS_CLICKHOUSE_PASSWORD', ''),
        'table' => (string) env('CBOX_ID_ANALYTICS_CLICKHOUSE_TABLE', 'id_analytics_events'),
        'timeout' => (int) env('CBOX_ID_ANALYTICS_CLICKHOUSE_TIMEOUT', 5),
    ],
     ...
     */
    'retention_days' => (int) env('CBOX_ID_ANALYTICS_RETENTION_DAYS', 365),

    /*
     * Default look-back window (in days) for the console charts.
     */
    'chart' => [
        'window_days' => (int) env('CBOX_ID_ANALYTICS_CHART_WINDOW_DAYS', 30),
    ],
];
