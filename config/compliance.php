...
return [
     ...
     */
    'enabled' => (bool) env('ID_COMPLIANCE_ENABLED', false),
     ...
     */
    'export' => [
        'sink' => (string) env('ID_COMPLIANCE_SINK', 'null'),

        'batch_size' => (int) env('ID_COMPLIANCE_BATCH_SIZE', 500),

        'jsonl' => [
            'disk' => (string) env('ID_COMPLIANCE_JSONL_DISK', 'local'),
            'path' => (string) env('ID_COMPLIANCE_JSONL_PATH', 'compliance/audit'),
        ],

        'siem' => [
            'endpoint' => (string) env('ID_COMPLIANCE_SIEM_ENDPOINT', ''),
            'token' => (string) env('ID_COMPLIANCE_SIEM_TOKEN', ''),
            'timeout' => (int) env('ID_COMPLIANCE_SIEM_TIMEOUT', 10),
        ],
    ],
     ...
     */
    'retention' => [
        'checkpoint_on_apply' => (bool) env('ID_COMPLIANCE_RETENTION_CHECKPOINT', true),
    ],
];
