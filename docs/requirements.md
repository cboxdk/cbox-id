...
|---|---|---|
| `cboxdk/laravel-id` | `>=0.58 <1.0` | The identity engine (crypto, tenancy, OAuth/OIDC, SCIM, SAML, audit). |
...
> `cboxdk/laravel-id` is pinned to a pre-1.0 series (`>=0.58 <1.0`). Minor bumps in that
