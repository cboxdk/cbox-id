...
| --- | --- | --- |
| `analytics` | Overview → Sign-in activity (`/sign-in-activity`) | Authentication activity dashboards over a pluggable event store. See [Analytics storage](../operations/analytics.md). |
